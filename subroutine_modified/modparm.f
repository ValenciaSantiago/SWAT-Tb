...
!     apex/command output files
      ...
      integer, dimension (:), allocatable :: count_D								!! Added by [talemayehu]
!     apex/command output files
!  septic inputs
...
! msub = max number of subbasins
	  ...
	  real*8, dimension (:), allocatable :: sub_pcp,pet_sub						!! Added by [talemayehu]
      real*8, dimension (:,:), allocatable :: sub_pcpA,pet_subA					!! Added by [talemayehu]
...
!! added for plant growth modification for tropics added by [talemayehu]
      integer, dimension (:), allocatable :: iseason, sos1, sos2, sos3, sos4, sos5 !! last three added by [svalencia] 
      integer :: w_size			!! added by [talemayehu]
	  real*8 :: smi_tr			!!added by [talemayehu]
