...
!!                               |climate change studies)
!!    sos1(:)     |month         |starting month of transition to wet season [talemayehu]
!!    sos2(:)     |month         |ending month of transition to wet season [talemayehu]
!!    sos3(:)     |month         |starting month of transition to wet season [svalencia]
!!    sos4(:)     |month         |ending month of transition to wet season [svalencia]
!!    sos5(:)     |month         |starting month of transition to wet season [svalencia]
...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
     ...
     &  sub_smfmn(1,i), sub_sftmp(1,i), sub_smtmp(1,i), sub_timp(1,i)
      ...
      read (101,*) fcst_reg(i)
	  read (101,*) sos1(i)   !!   added by [talemayehu]
      read (101,*) sos2(i)   !!   added by [talemayehu]
	  read (101,*) sos3(i)   !!   added by [svalencia]
      read (101,*) sos4(i)   !!   added by [svalencia]	 
	  read (101,*) sos5(i)   !!   added by [svalencia]	  
      read (101,5100) titldum
      read (101,5100) titldum
...
!!    set default values
	  ...
	  !!    default values for sos1 and sos2 as suggested in [ms] added by [talemayehu]
      if (sos1(i) <= 0 .AND. sub_lat(i) <= 0) sos1(i) = 8
      if (sos1(i) <= 0 .AND. sub_lat(i) > 0) sos1(i) = 3
      if (sos1(i) > 12) sos1(i) = 12
      if (sos2(i) <= 0 .AND. sub_lat(i) <= 0) sos2(i) = 9
      if (sos2(i) <= 0 .AND. sub_lat(i) > 0) sos2(i) = 4
      if (sos2(i) > 12) sos2(i) = 12
