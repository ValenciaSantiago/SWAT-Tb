...
!     allocate tropical plant growth variables [talemayehu]
	  allocate (iseason(mhru)) 
	  allocate (sos1(msub)) 
	  allocate (sos2(msub)) 
	  allocate (sos3(msub)) !! Added by [svalencia] 
	  allocate (sos4(msub)) !! Added by [svalencia]
	  allocate (sos5(msub)) !! Added by [svalencia]
...
!      allocate (hqd(nstep*3+1))  !! was 73, changed for urban
  ...
  !!    allocate (hqdsave(msub,49))
	  ...
	  allocate (sub_pcp(msub))						!! Added by [talemayehu]
	  allocate (pet_sub(mhru))                      !! Added by [talemayehu]
	  allocate (sub_pcpA(w_size,mhru))					!! Added by [talemayehu]
	  allocate (pet_subA(w_size,mhru))                   !! Added by [talemayehu]
	  allocate (count_D(mhru))                      !! Added by [talemayehu]
